...
# def process_and_save_data(domain_to_check):
...
#     excel_file = input("Enter the path to the Excel file with domain names: ")
    
#     try:
#         # Read domain names from Excel sheet
#         df = pd.read_excel(excel_file)
#         domain_names = df['Domain'].tolist()
        
    
#         # Process and save data for each domain
#         for domain_to_check in domain_names:
#             process_and_save_data(domain_to_check)
#     except Exception as e:
